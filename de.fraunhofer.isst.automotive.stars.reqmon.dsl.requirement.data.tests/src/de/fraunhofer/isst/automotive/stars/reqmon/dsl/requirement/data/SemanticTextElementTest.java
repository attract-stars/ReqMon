...
class SemanticTextElementTest {
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#Constructor}.
	 */
	@Test
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#getText()}.
	 */
	@Test
	void testGetText() {
		String name = "NAME";
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#setText(java.lang.String)}.
	 */
	@Test
	void testSetText() {
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#getType()}.
	 */
	@Test
	void testGetType() {
		SemanticTextElement st = new SemanticTextElement();
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#setType(de.fraunhofer.isst.automotive.stars.reqmon.dsl.mapping.ui.editor.RequirementType)}.
	 */
	@Test
	void testSetType() {
		SemanticTextElement st = new SemanticTextElement();
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#toString()}.
	 */
	@Test
	void testToString() {
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#equals(java.lang.Object)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#getElementName()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#getElementType()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#setElementName(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#setElementType(de.fraunhofer.isst.automotive.stars.reqmon.dsl.mapping.ui.editor.RequirementType)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link de.fraunhofer.isst.automotive.stars.reqmon.dsl.requirement.data.SemanticTextElement#getElementTypeComparator()}.
	 */
	@Test
	void testGetElementTypeComparator() {
		...
		List<SemanticTextElement> actual4 = Arrays.asList(st2,st4,st1,st3); // Das dürfte ein fehler sein weiö st2 vor st1 kommt
