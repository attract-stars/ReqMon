...
public class RequirementDSLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == RequirementDSLPackage.eINSTANCE)
			...
			case RequirementDSLPackage.OBJECT_SET:
				...
				return; 
			case RequirementDSLPackage.OBJECTS:
			...
			case RequirementDSLPackage.PRE_NOMINATIVE:
				if (rule == grammarAccess.getActorRule()) {
					...
					sequence_Object_PreNominative(context, (PreNominative) semanticObject); 
					return; 
				}
			...
			case RequirementDSLPackage.PREDICATE_SENTENCE:
				...
				return; 
			case RequirementDSLPackage.PROPERTIES:
	...
	/**
	 * Contexts:
	 *     Object returns PreNominative
	 *
	 * Constraint:
	 *     ((determiner=Quantification | article=Articles | article=RefArticles) (object+=WORD+ | object+=STRING))
	 */
	protected void sequence_Object_PreNominative(ISerializationContext context, PreNominative semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     ((quantifier=Quantification | article=Articles | article=RefArticles)? (object+=WORD+ | object+=STRING) (property+=WORD+ | property+=STRING))
	 */
