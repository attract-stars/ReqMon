...
public class RequirementDSLSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Existence_ExistKeyword_3_0_or_ExistsKeyword_3_1;
	protected AbstractElementAlias match_Existence_ThereKeyword_1_0_or_ThereKeyword_1_1;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Existence_ExistKeyword_3_0_or_ExistsKeyword_3_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getExistenceAccess().getExistKeyword_3_0()), new TokenAlias(false, false, grammarAccess.getExistenceAccess().getExistsKeyword_3_1()));
		match_Existence_ThereKeyword_1_0_or_ThereKeyword_1_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getExistenceAccess().getThereKeyword_1_0()), new TokenAlias(false, false, grammarAccess.getExistenceAccess().getThereKeyword_1_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Existence_ExistKeyword_3_0_or_ExistsKeyword_3_1.equals(syntax))
				emit_Existence_ExistKeyword_3_0_or_ExistsKeyword_3_1(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_Existence_ThereKeyword_1_0_or_ThereKeyword_1_1.equals(syntax))
				emit_Existence_ThereKeyword_1_0_or_ThereKeyword_1_1(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_Existence_ExistKeyword_3_0_or_ExistsKeyword_3_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 */
	protected void emit_Existence_ThereKeyword_1_0_or_ThereKeyword_1_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
