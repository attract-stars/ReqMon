 ...
 *   <li>{@link de.fraunhofer.isst.stars.requirementDSL.impl.ModalitySentenceImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModalitySentenceImpl extends ClauseImpl implements ModalitySentence
{
  ...
  public EList<Constraints> getConstraints()
  {
    if (constraints == null)
    {
      constraints = new EObjectContainmentEList<Constraints>(Constraints.class, this, RequirementDSLPackage.MODALITY_SENTENCE__CONSTRAINTS);
    }
    return constraints;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case RequirementDSLPackage.MODALITY_SENTENCE__CONSTRAINTS:
